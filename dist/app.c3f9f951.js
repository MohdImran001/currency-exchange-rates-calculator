...
},{"core-js/shim":"../node_modules/core-js/shim.js","regenerator-runtime/runtime":"../node_modules/babel-polyfill/node_modules/regenerator-runtime/runtime.js","core-js/fn/regexp/escape":"../node_modules/core-js/fn/regexp/escape.js"}],"views/error.js":[function(require,module,exports) {
exports.html = function () {
  return "\n      <div class=\"ui {{color}} inverted segment\" style=\"height:250px;\">\n          <br>\n          <h2 class=\"ui center aligned icon header\">\n            <i class=\"exclamation triangle icon\"></i>\n            <div class=\"content\">\n              {{title}}\n              <div class=\"sub header\">{{message}}</div>\n            </div>\n          </h2>\n      </div>\n  ";
};
},{}],"views/rates-template.js":[function(require,module,exports) {
exports.html = function () {
...
},{}],"views/exchange-template.js":[function(require,module,exports) {
exports.html = function () {
...
},{}],"views/historical-template.js":[function(require,module,exports) {
exports.html = function () {
...
var getConversionResults = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    var from, to, amount, response, rate, result, error_template;
  ...
  return function getConversionResults() {
...
var getHistoricalRates = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
    var date, response, _response$data, base, rates, rates_template, html, error_template;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 4:
            ...
            _response$data = response.data, base = _response$data.base, rates = _response$data.rates;
            rates_template = Handlebars.compile(ratesTemplate.html());
            html = rates_template({
              base: base,
              date: date,
              rates: rates
          ...
          case 11:
            ...
            error_template = Handlebars.compile(errorTemplate.html());
            showError(_context2.t0, app, error_template);
  ...
  return function getHistoricalRates() {
...
},{"../views/error":"views/error.js","../views/rates-template":"views/rates-template.js"}],"js/router.js":[function(require,module,exports) {
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
...
router.add('/exchange', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
  ...
  return regeneratorRuntime.wrap(function _callee2$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          exchange_template = Handlebars.compile(exchangeTemplate.html());
          html = exchange_template();
          app.html(html);
          _context2.prev = 3;
          _context2.next = 6;
  ...
  return regeneratorRuntime.wrap(function _callee3$(_context3) {
    while (1) {
      switch (_context3.prev = _context3.next) {
        case 0:
          historical_template = Handlebars.compile(historicalTemplate.html());
...
},{"../views/error":"views/error.js","../views/rates-template":"views/rates-template.js","../views/exchange-template":"views/exchange-template.js","../views/historical-template":"views/historical-template.js","./util":"js/util.js"}],"js/app.js":[function(require,module,exports) {
"use strict";
...
window.addEventListener('load', function () {
  ...
  var link = $("a[href$='".concat(window.location.pathname, "']"));
  link.addClass('active');
  $('a').on('click', function (e) {
    //block browser to reload
    e.preventDefault(); //add active class
...
},{"regenerator-runtime/runtime":"../node_modules/regenerator-runtime/runtime.js","babel-polyfill":"../node_modules/babel-polyfill/lib/index.js","./router":"js/router.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
